...
// Define product details for Classic Hoops
$product = [
    'id' => 'EHOOP001', // Unique Product ID for Classic Hoops
    'name' => 'Classic Hoops',
    'price' => 120.00,
    // IMPORTANT: Ensure these paths are correct relative to where your shopping_cart.php and product_detail files are.
    'image' => 'imgs/earrings1.webp', // Main image path
    'hover_image' => 'imgs/earrings2.webp', // Hover image path
    'description' => 'Timeless and versatile, our Classic Hoops are an essential addition to any jewellery collection. Crafted with polished metal, these elegant hoops offer a perfect blend of simplicity and sophistication, suitable for everyday wear or special occasions. Their lightweight design ensures comfort, making them a go-to accessory for any outfit.',
...
<body>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="earring-detail-1.php" method="post">
