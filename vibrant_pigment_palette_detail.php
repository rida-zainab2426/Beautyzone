...
<head>
    ...
    <title>Vibrant Pigment Palette - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'vibrant_pigment_palette_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($cosmeticCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (strpos(basename($_SERVER['PHP_SELF']), 'eyeshadow') !== false && $name == 'Eye Shadows')) ? 'active' : '';
    ...
    <header class="category-header">
        <div class="container">
            <h1>Vibrant Pigment Palette</h1>
            <p><a href="index.php">Home</a> - <a href="eyeshadows.php">Eye Shadows</a> - Vibrant Pigment Palette</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Vibrant Pigment Palette3.webp" alt="Vibrant Pigment Palette Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Vibrant Pigment Palette2.webp" alt="Vibrant Pigment Palette Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Vibrant Pigment Palette3.webp" alt="Vibrant Pigment Palette Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Vibrant Pigment Palette2.webp" alt="Vibrant Pigment Palette Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="vibrant_pigment_palette">Vibrant Pigment Palette</h1>
            ...
            <p class="product-description">
                Unleash a spectrum of color with our Vibrant Pigment Palette. This exquisite palette features an array of intensely pigmented shades, from bold mattes to dazzling shimmers, designed to create captivating eye looks. The buttery-smooth formula blends seamlessly, ensuring vibrant, long-lasting color that stays true all day.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="vibrant_pigment_palette">
                <input type="hidden" name="name" value="Vibrant Pigment Palette">
                <input type="hidden" name="price" value="29.99">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Vibrant Pigment Palette.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-palette"></i> Wide Range of Vibrant Colors</li>
                <li><i class="fas fa-brush"></i> Intensely Pigmented & Blendable</li>
                <li><i class="fas fa-adjust"></i> Matte & Shimmer Finishes</li>
                <li><i class="fas fa-hourglass-half"></i> Long-Lasting & Crease-Resistant</li>
                <li><i class="fas fa-check-circle"></i> Cruelty-Free & Vegan</li>
            </ul>
        </div>
    </div>
