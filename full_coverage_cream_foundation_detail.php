...
<head>
    ...
    <title>Full Coverage Cream Foundation - Beautyzone</title>
...
<body>
            ...
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php
                        // Also make the specific foundation category active if on a foundation detail page
                        foreach ($cosmeticCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (basename($_SERVER['PHP_SELF']) == 'hydrating_liquid_foundation_detail.php' && $name == 'Foundations') || (basename($_SERVER['PHP_SELF']) == 'matte_finish_foundation_detail.php' && $name == 'Foundations') || (basename($_SERVER['PHP_SELF']) == 'full_coverage_cream_foundation_detail.php' && $name == 'Foundations')) ? 'active' : '';
    ...
    <header class="category-header">
        <div class="container">
            <h1>Full Coverage Cream Foundation</h1>
            <p><a href="index.php">Home</a> - <a href="foundations.php">Foundations</a> - Full Coverage Cream Foundation</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Full Coverage Cream Foundation.webp" alt="Full Coverage Cream Foundation Main" class="product-main-image" id="mainProductImage">
            ...
            <div class="thumbnail-images">
                <img src="imgs/Full Coverage Cream Foundation.webp" alt="Full Coverage Cream Foundation Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Full Coverage Cream Foundation2.webp" alt="Full Coverage Cream Foundation Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title">Full Coverage Cream Foundation</h1>
            ...
            <p class="product-availability">In Stock: <span id="itemsInStock">45</span> Items</p>
            <p class="product-description">
                Experience unparalleled perfection with our Full Coverage Cream Foundation. This luxurious formula effortlessly conceals imperfections, hyperpigmentation, and blemishes, delivering a flawless, airbrushed finish. Its creamy, buildable texture blends seamlessly into the skin, providing comfortable wear without caking or creasing. Enriched with nourishing ingredients, it keeps your skin hydrated while offering long-lasting coverage for a radiant, picture-perfect complexion. Ideal for all skin types seeking maximum coverage with a natural feel.
            </p>
