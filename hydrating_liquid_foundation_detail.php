...
<head>
    ...
    <title>Hydrating Liquid Foundation - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'hydrating_liquid_foundation_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($cosmeticCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (strpos(basename($_SERVER['PHP_SELF']), 'foundation') !== false && $name == 'Foundations')) ? 'active' : '';
    ...
    <header class="category-header">
        <div class="container">
            <h1>Hydrating Liquid Foundation</h1>
            <p><a href="index.php">Home</a> - <a href="foundations.php">Foundations</a> - Hydrating Liquid Foundation</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Hydrating Liquid Foundation.webp" alt="Hydrating Liquid Foundation Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Hydrating Liquid Foundation 2.webp" alt="Hydrating Liquid Foundation Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Hydrating Liquid Foundation.webp" alt="Hydrating Liquid Foundation Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Hydrating Liquid Foundation 2.webp" alt="Hydrating Liquid Foundation Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="hydrating_liquid_foundation">Hydrating Liquid Foundation</h1>
            ...
            <p class="product-price" data-price="25.00">$25.00</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">50</span> Items</p>
            <p class="product-description">
                Achieve a flawless, radiant complexion with our Hydrating Liquid Foundation. This lightweight, buildable formula blends seamlessly into the skin, providing natural-looking coverage while infusing your skin with essential moisture. Perfect for all skin types, especially dry or normal, it leaves your skin feeling supple and looking luminous all day long without caking or settling into fine lines.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="hydrating_liquid_foundation">
                <input type="hidden" name="name" value="Hydrating Liquid Foundation">
                <input type="hidden" name="price" value="25.00">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Hydrating Liquid Foundation.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-water"></i> Hydrating Formula</li>
                <li><i class="fas fa-lightbulb"></i> Radiant Finish</li>
                <li><i class="fas fa-palette"></i> Buildable Coverage</li>
                <li><i class="fas fa-leaf"></i> Lightweight & Breathable</li>
                <li><i class="fas fa-check-circle"></i> Suitable for All Skin Types</li>
            </ul>
        </div>
    </div>
