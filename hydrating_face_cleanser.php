...
// Define product details for Hydrating Face Cleanser
$product = [
    'id' => 'HFC001', // Unique Product ID for Hydrating Face Cleanser
    'name' => 'Hydrating Face Cleanser',
    'price' => 16.00,
    'image' => 'imgs/hydrating face cleanser.webp', // Original path as requested to keep same
    'hover_image' => 'imgs/hydrating face cleanser2.webp', // Original path as requested to keep same
    'description' => 'Gently cleanse your skin while maintaining its natural moisture balance with our Hydrating Face Cleanser. This creamy, non-foaming formula effectively removes impurities, makeup, and excess oil without stripping the skin, leaving it feeling soft, supple, and refreshed. Infused with hydrating ingredients, it\'s perfect for daily use on all skin types, especially dry or sensitive skin.',
    'stock' => 65, // Example stock
    'reviews_count' => 15, // Number of reviews
    'rating' => 5.0, // Average rating based on full stars in original HTML
];
...
<body>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="skincare.php">Skincare</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="hydrating_face_cleanser.php" method="post">
