...
<head>
    ...
    <title>Radiant Glow Foundation - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'radiant_glow_foundation_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Radiant Glow Foundation</h1>
            <p><a href="index.php">Home</a> - <a href="foundations.php">Foundations</a> - Radiant Glow Foundation</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Radiant Glow Foundation.webp" alt="Radiant Glow Foundation Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Radiant Glow Foundation2.webp" alt="Radiant Glow Foundation Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Radiant Glow Foundation.webp" alt="Radiant Glow Foundation Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Radiant Glow Foundation2.webp" alt="Radiant Glow Foundation Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="radiant_glow_foundation">Radiant Glow Foundation</h1>
            ...
            <p class="product-description">
                Achieve a luminous and healthy-looking complexion with our Radiant Glow Foundation. This lightweight, buildable formula provides seamless coverage while enhancing your skin's natural radiance. Infused with light-reflecting particles, it blurs imperfections and creates a soft-focus effect for a flawless, glowing finish that lasts all day.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="radiant_glow_foundation">
                <input type="hidden" name="name" value="Radiant Glow Foundation">
                <input type="hidden" name="price" value="29.99">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Radiant Glow Foundation.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-star"></i> Luminous Finish</li>
                <li><i class="fas fa-magic"></i> Blurs Imperfections</li>
                <li><i class="fas fa-layer-group"></i> Buildable Coverage</li>
                <li><i class="fas fa-lightbulb"></i> Enhances Natural Radiance</li>
