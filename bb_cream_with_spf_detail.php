...
<head>
    ...
    <title>BB Cream with SPF - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'bb_cream_with_spf_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>BB Cream with SPF</h1>
            <p><a href="index.php">Home</a> - <a href="foundations.php">Foundations</a> - BB Cream with SPF</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/BB Cream with SPF3.webp" alt="BB Cream with SPF Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/BB Cream with SPF2.webp" alt="BB Cream with SPF Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/BB Cream with SPF3.webp" alt="BB Cream with SPF Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/BB Cream with SPF2.webp" alt="BB Cream with SPF Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="bb_cream_with_spf">BB Cream with SPF</h1>
            ...
            <p class="product-description">
                Simplify your beauty routine with our versatile BB Cream with SPF. This all-in-one product combines skincare benefits with light coverage, hydrating your skin, evening out your complexion, and protecting it from the sun's harmful rays with built-in SPF. It's the perfect solution for a natural, healthy glow and effortless daily protection.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="bb_cream_with_spf">
                <input type="hidden" name="name" value="BB Cream with SPF">
                <input type="hidden" name="price" value="18.99">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/BB Cream with SPF.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-sun"></i> Built-in SPF Protection</li>
                <li><i class="fas fa-tint"></i> Hydrating Formula</li>
                <li><i class="fas fa-compress-alt"></i> Light to Medium Coverage</li>
                <li><i class="fas fa-hand-sparkles"></i> Evens Skin Tone</li>
                <li><i class="fas fa-check-circle"></i> All-in-One Solution</li>
            </ul>
        </div>
    </div>
