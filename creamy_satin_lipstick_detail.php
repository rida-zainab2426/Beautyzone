...
<head>
    ...
    <title>Creamy Satin Lipstick - Beautyzone</title>
...
<body>
    ...
    <?php
    // Start session to access cart data in the header badge
    // session_start();
    ...
    <header class="category-header">
        <div class="container">
            <h1>Creamy Satin Lipstick</h1>
            <p><a href="index.php">Home</a> - <a href="lipsticks.php">Lipsticks</a> - Creamy Satin Lipstick</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Creamy Satin Lipstick.webp" alt="Creamy Satin Lipstick Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Creamy Satin Lipstick2.webp" alt="Creamy Satin Lipstick Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Creamy Satin Lipstick.webp" alt="Creamy Satin Lipstick Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Creamy Satin Lipstick2.webp" alt="Creamy Satin Lipstick Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="creamy_satin_lipstick">Creamy Satin Lipstick</h1>
            ...
            <p class="product-price" data-price="18.00">$18.00</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">35</span> Items</p>
            <p class="product-description">
                Indulge your lips with our Creamy Satin Lipstick, offering luxurious color with a beautiful, soft sheen. This rich formula glides on effortlessly, providing full coverage and comfortable wear throughout the day. Infused with moisturizing ingredients, it keeps your lips feeling hydrated and smooth, preventing dryness. Perfect for adding a touch of elegance to any look, from everyday chic to sophisticated evening glam.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="creamy_satin_lipstick">
                <input type="hidden" name="name" value="Creamy Satin Lipstick">
                <input type="hidden" name="price" value="18.00">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Creamy Satin Lipstick.webp"> <div class="quantity-selector">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-tint"></i> Rich, Creamy Color</li>
                <li><i class="fas fa-magic"></i> Luxurious Satin Finish</li>
                <li><i class="fas fa-hand-holding-heart"></i> Hydrating & Comfortable Wear</li>
                <li><i class="fas fa-paint-roller"></i> Smooth, Effortless Application</li>
                <li><i class="fas fa-check-circle"></i> Long-Lasting Formula</li>
            </ul>
        </div>
    </div>
<?php include 'footer.php'; ?>
    ...
    <script>
        ...
        // No need for cartBadge.textContent update from localStorage here, as PHP now handles it.
        // const cartBadge = document.getElementById('cartBadge'); // Still needed to get element for initial PHP value.
        ...
        function changeMainImage(thumbnail) {
            ...
            // Update the hover image source (if you have a separate one for hover)
            ...
            // Update the hidden input field for the image so it's sent with the form
        ...
        // The add to cart button no longer needs an event listener here,
        // as it's now a submit button within the form.
        // localStorage functionality for cart has been removed from this file.
