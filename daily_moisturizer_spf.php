...
// Define product details for Daily Moisturizer SPF
$product = [
    'id' => 'DMS001', // Unique Product ID for Daily Moisturizer SPF
    'name' => 'Daily Moisturizer SPF',
    'price' => 28.00,
    'image' => 'imgs/Daily Moisturizer with SPF.webp', // Original path as requested to keep same
    'hover_image' => 'imgs/Daily Moisturizer with SPF2.webp', // Original path as requested to keep same
    'description' => 'Protect and nourish your skin daily with our lightweight Daily Moisturizer with SPF. This essential formula combines broad-spectrum UVA/UVB protection with powerful hydrating ingredients like hyaluronic acid and antioxidants. It absorbs quickly, leaving no greasy residue, and provides all-day moisture while guarding against sun damage and environmental stressors. Perfect for all skin types, it primes your skin for makeup application or can be worn alone for a healthy, radiant finish.',
    'stock' => 50, // Example stock
    'reviews_count' => 30, // Number of reviews
...
<body>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="daily_moisturizer_spf.php" method="post">
