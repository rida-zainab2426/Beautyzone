...
<head>
    ...
    <title>Powder Blush - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'powder_blush_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Powder Blush</h1>
            <p><a href="index.php">Home</a> - <a href="blushes.php">Blushes</a> - Powder Blush</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Powder Blush Palette.webp" alt="Powder Blush Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Powder Blush Palette2.webp" alt="Powder Blush Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Powder Blush Palette.webp" alt="Powder Blush Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Powder Blush Palette2.webp" alt="Powder Blush Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="powder_blush">Powder Blush</h1>
            ...
            <p class="product-price" data-price="22.00">$22.00</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">75</span> Items</p>
            <p class="product-description">
                Achieve a natural flush with our finely milled Powder Blush. Its silky smooth texture blends effortlessly, delivering buildable color for a soft, radiant finish that lasts all day. Available in a range of flattering shades.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="powder_blush">
                <input type="hidden" name="name" value="Powder Blush">
                <input type="hidden" name="price" value="22.00">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Powder Blush.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-check-circle"></i> Finely Milled Formula</li>
                <li><i class="fas fa-tint"></i> Buildable & Blendable Color</li>
                <li><i class="fas fa-sun"></i> Natural Radiant Finish</li>
                <li><i class="fas fa-clock"></i> Long-Lasting Wear</li>
                <li><i class="fas fa-palette"></i> Available in Multiple Shades</li>
            </ul>
        </div>
    </div>
