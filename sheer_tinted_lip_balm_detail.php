...
// Product Data for Sheer Tinted Lip Balm
$product = [
    'id' => 'STLB001', // Unique product ID
    'name' => 'Sheer Tinted Lip Balm',
    'price' => 8.00,
    'stock' => 60,
    'image_main' => 'imgs/Sheer Tinted Lip Balm.webp',
    'image_hover' => 'imgs/Sheer Tinted Lip Balm2.webp',
    'description' => 'Experience the perfect blend of hydration and subtle color with our Sheer Tinted Lip Balm. Formulated with shea butter and natural oils, this balm deeply moisturizes dry lips while leaving a delicate tint for a healthy, natural look. It\'s ideal for a no-makeup makeup day or when you need a quick touch-up with a hint of vibrancy. Enjoy soft, supple, and beautifully tinted lips all day.',
    'reviews' => 8,
    'rating' => 5.0, // Example rating based on provided stars
    'features' => [
        'Deeply Hydrating Formula',
        'Natural Sheer Tint',
        'Enriched with Shea Butter & Natural Oils',
        'SPF 15 Protection', // Assuming this based on the commented line in your original code
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    // Basic validation
    if ($product_id === $product['id'] && $quantity > 0 && $quantity <= $product['stock']) {
        ...
        // You might want to handle this case more gracefully, e.g., show an error on the page
        echo "<script>alert('Error adding product to cart. Please check quantity or product availability.');</script>";
    }
}
...
<head>
    ...
    <style>
        ...
        .logo a {
            ...
            font-family: 'Playfair Display', serif; /* Use a distinct font */
            font-size: 2.2em; /* Adjust size as needed */
            font-weight: 700; /* Make it bold */
            padding: 5px 0; /* Add some padding */
        }
        /* No need for .logo img styles anymore for text logo */
            ...
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php
                        // Also make the specific lipstick category active if on a lipstick detail page
                        foreach ($cosmeticCategories as $name => $file) {
                            // Check if the current page is a lipstick detail page or the general lipstick category page
                            $isLipstickDetailOrCategory = (basename($_SERVER['PHP_SELF']) == 'sheer_tinted_lip_balm_detail.php' && $name == 'Lipsticks');
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || $isLipstickDetailOrCategory) ? 'active' : '';
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="<?php echo htmlspecialchars($product['image_main']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Main" class="product-main-image" id="mainProductImage">
                <img src="<?php echo htmlspecialchars($product['image_hover']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="<?php echo htmlspecialchars($product['image_main']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="<?php echo htmlspecialchars($product['image_hover']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>
        ...
        <div class="product-info">
            ...
            <form action="" method="POST">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="text" value="1" name="quantity" id="productQuantity" readonly>
