...
<head>
    ...
    <title>Matte Finish Foundation - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'matte_finish_foundation_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Matte Finish Foundation</h1>
            <p><a href="index.php">Home</a> - <a href="foundations.php">Foundations</a> - Matte Finish Foundation</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Matte Finish Foundation.webp" alt="Matte Finish Foundation Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Matte Finish Foundation2.webp" alt="Matte Finish Foundation Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Matte Finish Foundation.webp" alt="Matte Finish Foundation Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Matte Finish Foundation2.webp" alt="Matte Finish Foundation Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="matte_finish_foundation">Matte Finish Foundation</h1>
            ...
            <p class="product-price" data-price="22.50">$22.50</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">40</span> Items</p>
            <p class="product-description">
                Achieve a perfectly smooth, shine-free complexion with our Matte Finish Foundation. This innovative formula controls oil and minimizes the appearance of pores, providing a long-lasting, velvety matte finish without feeling dry or heavy. Ideal for oily and combination skin types, it offers medium to full buildable coverage that stays put throughout the day, ensuring you look fresh and polished from morning to night.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="matte_finish_foundation">
                <input type="hidden" name="name" value="Matte Finish Foundation">
                <input type="hidden" name="price" value="22.50">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Matte Finish Foundation.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-moon"></i> Flawless Matte Finish</li>
                <li><i class="fas fa-oil-can"></i> Oil Control Formula</li>
                <li><i class="fas fa-expand-arrows-alt"></i> Minimizes Pores</li>
                <li><i class="fas fa-clock"></i> Long-Lasting Wear</li>
                <li><i class="fas fa-check-circle"></i> Medium to Full Coverage</li>
            </ul>
        </div>
    </div>
