...
// Define product details for Delicate Gold Chain
$product = [
    'id' => 'DGC001', // Unique Product ID for Delicate Gold Chain
    ...
    'image' => 'imgs/delicate gold chain.webp',
    'hover_image' => 'imgs/delicate gold chain2.webp', // If you have a hover image
    'description' => 'Adorn yourself with the timeless elegance of our Delicate Gold Chain. Crafted from exquisite 14K gold, this minimalist chain is designed for everyday wear, offering a subtle sparkle that complements any outfit. Its lightweight and durable design makes it perfect for layering with other necklaces or wearing on its own for a classic, sophisticated look. A versatile piece that adds a touch of luxury to your jewelry collection.',
...
<head>
    ...
    <title>Delicate Gold Chain - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($jewelleryCategories)) || basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php') ? 'active' : ''; ?>">Jewellery <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($jewelleryCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' && $name == 'Necklaces')) ? 'active' : '';
                            echo '<li><a href="' . htmlspecialchars($file) . '" class="' . $activeClass . '">' . htmlspecialchars($name) . '</a></li>';
                        }
                        ?>
                    </ul>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="product_detail_delicate_gold_chain.php" method="post">
