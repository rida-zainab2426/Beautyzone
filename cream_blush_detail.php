...
<head>
    ...
    <title>Cream Blush - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'cream_blush_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Cream Blush</h1>
            <p><a href="index.php">Home</a> - <a href="blushes.php">Blushes</a> - Cream Blush</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Cream Blush Stick.webp" alt="Cream Blush Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Cream Blush Stick.webp" alt="Cream Blush Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Cream Blush Stick.webp" alt="Cream Blush Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Cream Blush Stick.webp" alt="Cream Blush Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="cream_blush">Cream Blush</h1>
            ...
            <p class="product-description">
                Our Cream Blush delivers a dewy, natural-looking flush of color to your cheeks. Its creamy, blendable formula melts into the skin for a seamless finish, providing a healthy glow that lasts all day. Perfect for a fresh, youthful look.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="cream_blush">
                <input type="hidden" name="name" value="Cream Blush">
                <input type="hidden" name="price" value="25.00">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Cream Blush.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-hand-sparkles"></i> Dewy, Natural Finish</li>
                <li><i class="fas fa-paint-brush"></i> Creamy, Blendable Formula</li>
                <li><i class="fas fa-grin-beam"></i> Healthy, Youthful Glow</li>
                <li><i class="fas fa-calendar-alt"></i> Long-Lasting Wear</li>
                <li><i class="fas fa-feather-alt"></i> Lightweight & Comfortable</li>
            </ul>
        </div>
    </div>
