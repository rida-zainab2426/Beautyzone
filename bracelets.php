...
<head>
    ...
    <style>
        ...
        .logo a {
            display: block;
            /* Added styling for text logo */
            font-family: 'Playfair Display', serif;
            font-size: 2.2em; /* Adjust size as needed */
            font-weight: 700;
            color: #000; /* Or a darker shade to stand out */
            text-decoration: none;
        }
        /* .logo img { Removed as text is replacing image
            height: 60px;
            width: auto;
            display: block;
        } */
        ...
        @media (max-width: 768px) {
            ...
            .logo a { height: auto; font-size: 2em; } /* Adjust font size for mobile logo */
...
<body>
    ...
    $jewelleryCategories = [
        ...
        'Rings' => 'rings.php',
        'Bracelets' => 'bracelets.php', // This is the current page
    ...
    // Define bracelets product data (only 6 cards with easy names)
    $braceletsProducts = [
        [
            'id' => 1,
            'name' => 'Charm Bracelet',
            'category' => 'Jewellery',
            'price' => '75.00',
            'main_image' => 'imgs/Charm Bracelet.webp',
            'hover_image' => 'imgs/Charm Bracelet2.webp',
            'detail_page' => 'bracelet-detail-1.php',
            'badge' => 'New'
        ],
        [
            'id' => 2,
            ...
            'category' => 'Jewellery',
            'price' => '110.00',
            'main_image' => 'imgs/Pearl Strand Bracelet.webp',
            'hover_image' => 'imgs/Pearl Strand Bracelet2.webp',
            'detail_page' => 'bracelet-detail-2.php',
            'badge' => null
        ],
        [
            'id' => 3,
            ...
            'category' => 'Jewellery',
            'price' => '90.00',
            'main_image' => 'imgs/Cuff Bangle.webp',
            'hover_image' => 'imgs/Cuff Bangle2.webp',
            'detail_page' => 'bracelet-detail-3.php',
            'badge' => 'Best'
        ],
        [
            'id' => 4,
            ...
            'category' => 'Jewellery',
            'price' => '45.50',
            'main_image' => 'imgs/Beaded Bracelet.webp',
            'hover_image' => 'imgs/Beaded Bracelet2.webp',
            'detail_page' => 'bracelet-detail-4.php',
            'badge' => null
        ],
        [
            'id' => 5,
            ...
            'category' => 'Jewellery',
            'price' => '150.00',
            'main_image' => 'imgs/Chain Bracelet.webp',
            'hover_image' => 'imgs/Chain Bracelet2.webp',
            'detail_page' => 'bracelet-detail-5.php',
            'badge' => null
        ],
        [
            'id' => 6,
            ...
            'category' => 'Jewellery',
            'price' => '30.00',
            'main_image' => 'imgs/img11.webp',
            'hover_image' => 'imgs/img12.webp',
            'detail_page' => 'bracelet-detail-6.php',
            'badge' => null
        ]
    ];
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        foreach ($jewelleryCategories as $name => $file) {
                            // The active class for the current page (Bracelets)
    ...
    <section class="category-header">
        <div class="container">
            <h1>Bracelets</h1>
            <p><a href="index.php">Home</a> &gt; Bracelets</p>
        </div>
    </section>

    <main class="product-grid-container">
        <div class="product-grid">
            <?php foreach ($braceletsProducts as $product): ?>
