...
<head>
    ...
    <title>Mineral Powder Foundation - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'mineral_powder_foundation_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Mineral Powder Foundation</h1>
            <p><a href="index.php">Home</a> - <a href="foundations.php">Foundations</a> - Mineral Powder Foundation</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Mineral Powder Foundation.webp" alt="Mineral Powder Foundation Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Mineral Powder Foundation2.webp" alt="Mineral Powder Foundation Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Mineral Powder Foundation.webp" alt="Mineral Powder Foundation Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Mineral Powder Foundation2.webp" alt="Mineral Powder Foundation Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="mineral_powder_foundation">Mineral Powder Foundation</h1>
            ...
            <p class="product-availability">In Stock: <span id="itemsInStock">60</span> Items</p>
            <p class="product-description">
                Discover the natural beauty of our Mineral Powder Foundation. Made with finely milled minerals, this lightweight powder provides buildable coverage that perfects your complexion without clogging pores or feeling heavy. It offers a luminous, soft-focus finish, reducing the appearance of fine lines and imperfections, and is gentle enough for even the most sensitive skin. Achieve a healthy, radiant glow effortlessly.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="mineral_powder_foundation">
                <input type="hidden" name="name" value="Mineral Powder Foundation">
                <input type="hidden" name="price" value="28.00">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Mineral Powder Foundation.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-leaf"></i> Natural Mineral Formula</li>
                <li><i class="fas fa-weight-light"></i> Lightweight & Breathable</li>
                <li><i class="fas fa-palette"></i> Buildable Coverage</li>
                <li><i class="fas fa-magic"></i> Soft-Focus Finish</li>
                <li><i class="fas fa-check-circle"></i> Suitable for Sensitive Skin</li>
            </ul>
        </div>
    </div>
