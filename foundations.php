...
<head>
    ...
    <title>Foundations - Beautyzone</title>
    ...
    <style>
        ...
        /* Category Header styling (re-using from lipsticks.php, already centered) */
        .category-header {
        ...
        /* Badge for "Best" */
        .product-card .badge { /* Targeting badge specifically within product card */
            position: absolute;
            top: 10px;
            right: 10px;
...
<body>
    ...
    $cosmeticCategories = [
        ...
        "Foundations" => "foundations.php", // This page
    ...
    <header class="category-header">
        <div class="container">
            <h1>Foundations</h1>
            <p><a href="index.php">Home</a> - Foundations</p>
        </div>
    </header>
    ...
    <main class="product-grid-container">
        <div class="container">
            <div class="product-grid" id="productGrid">
                <a href="hydrating_liquid_foundation_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Foundations" data-title="Hydrating Liquid Foundation">
                        <div class="product-image-wrapper">
                            <img src="imgs/Hydrating Liquid Foundation.webp" alt="Hydrating Liquid Foundation" class="product-main-image">
                            <img src="imgs/Hydrating Liquid Foundation2.webp" alt="Hydrating Liquid Foundation Hover" class="product-hover-image">
                            <span class="badge">New</span>
                        </div>
                        <div class="product-details">
                            <p class="product-category">Foundations</p>
                            <h3 class="product-title">Hydrating Liquid Foundation</h3>
                            <p class="product-price">Starts from $22.00</p>
                        </div>
                    </div>
                </a>

                <a href="matte_finish_foundation_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Foundations" data-title="Matte Finish Foundation">
                        <div class="product-image-wrapper">
                            <img src="imgs/Matte Finish Foundation.webp" alt="Matte Finish Foundation" class="product-main-image">
                            <img src="imgs/Matte Finish Foundation2.webp" alt="Matte Finish Foundation Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Foundations</p>
                ...
                <a href="full_coverage_cream_foundation_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Foundations" data-title="Full Coverage Cream Foundation">
                        <div class="product-image-wrapper">
                            <img src="imgs/Full Coverage Cream Foundation.webp" alt="Full Coverage Cream Foundation" class="product-main-image">
                            <img src="imgs/Full Coverage Cream Foundation2.webp" alt="Full Coverage Cream Foundation Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Foundations</p>
                            <h3 class="product-title">Full Coverage Cream Foundation</h3>
                            <p class="product-price">Starts from $25.00</p>
                        </div>
                    </div>
                </a>

                <a href="mineral_powder_foundation_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Foundations" data-title="Mineral Powder Foundation">
                        <div class="product-image-wrapper">
                            <img src="imgs/Mineral Powder Foundation.webp" alt="Mineral Powder Foundation" class="product-main-image">
                            <img src="imgs/Mineral Powder Foundation2.webp" alt="Mineral Powder Foundation Hover" class="product-hover-image">
                            <span class="badge">Best Seller</span>
                        </div>
                        <div class="product-details">
                            <p class="product-category">Foundations</p>
                            <h3 class="product-title">Mineral Powder Foundation</h3>
                            <p class="product-price">Starts from $18.00</p>
                        </div>
                    </div>
                </a>

                <a href="bb_cream_with_spf_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Foundations Skincare" data-title="BB Cream with SPF">
                        <div class="product-image-wrapper">
                            <img src="imgs/BB Cream with SPF2.webp" alt="BB Cream with SPF" class="product-main-image">
                            <img src="imgs/BB Cream with SPF3.webp" alt="BB Cream with SPF Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Foundations - Skincare</p>
                            <h3 class="product-title">BB Cream with SPF</h3>
                            <p class="product-price">Starts from $17.00</p>
                        </div>
                    </div>
                </a>

                <a href="radiant_glow_foundation_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Foundations" data-title="Radiant Glow Foundation">
                        <div class="product-image-wrapper">
                            <img src="imgs/Radiant Glow Foundation.webp" alt="Radiant Glow Foundation" class="product-main-image">
                            <img src="imgs/Radiant Glow Foundation2.webp" alt="Radiant Glow Foundation Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Foundations</p>
                            <h3 class="product-title">Radiant Glow Foundation</h3>
                            <p class="product-price">Starts from $23.00</p>
                        </div>
                    </div>
                </a>
            </div>
        ...
        function filterProducts(searchTerm) {
            ...
            productCards.forEach(card => {
                ...
                if (title.includes(lowerCaseSearchTerm) || category.includes(lowerCaseSearchTerm)) {
                    card.closest('.product-card-link').style.display = 'block'; // Show the parent link
                } else {
                    card.closest('.product-card-link').style.display = 'none'; // Hide the parent link
                }
            });
        }
