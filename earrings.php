...
<head>
    ...
    <title>Earrings - Beautyzone</title>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700&family=Playfair+Display:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* Your Provided CSS Starts Here (This section should ideally be in a separate style.css file) */
        body {
        ...
        .logo a {
            display: block;
            font-family: 'Playfair Display', serif; /* Use the heading font */
        ...
        .badge {
            position: absolute;
            top: 10px; /* Adjusted to be consistent with product badges */
            right: 10px; /* Adjusted to be consistent with product badges */
        ...
        .category-header .container {
            ...
            position: relative; /* Needed for positioning leaf within container */
        }
        ...
        .category-header h1 {
            ...
            padding-left: 170px; /* Add padding to make space for the leaf */
        }
        ...
        @media (max-width: 1024px) {
            ...
            .category-header h1 { font-size: 2.5em; padding-left: 140px; }
            .category-header p { padding-left: 140px; }
            .category-header::before {
        ...
        @media (max-width: 768px) {
            ...
            .logo a { font-size: 2em; } /* Adjust font size for mobile logo */
            ...
            .category-header h1 { font-size: 2.2em; padding-left: 120px; }
            .category-header p { font-size: 0.8em; padding-left: 120px; }
            .category-header::before {
                width: 100px; /* Smaller */
        ...
        @media (max-width: 480px) {
            ...
            .logo a { font-size: 1.8em; } /* Further adjust font size for smaller mobile screens */
            ...
            .category-header h1 { font-size: 1.8em; padding-left: 90px; }
            .category-header p { font-size: 0.8em; padding-left: 90px; }
            .category-header::before {
                width: 80px;
                height: 80px;
                left: 0;
...
<body>
    ...
    <?php
    // Define cosmetics categories with the new arrangements
    $cosmeticCategories = [
    ...
    // Define detail pages for Cosmetics dropdown active state (update as needed)
    $cosmeticDetailPages = [
    ...
    // Define earrings product data (only 6 cards with easy names)
    $earringsProducts = [
        [
            'id' => 1,
            'name' => 'Classic Hoops',
            'category' => 'Jewellery',
            'price' => '120.00',
            'main_image' => 'imgs/earrings1.webp',
            'hover_image' => 'imgs/earrings2.webp',
            'detail_page' => 'earring-detail-1.php',
            'badge' => 'New'
        ],
        [
            'id' => 2,
            ...
            'category' => 'Jewellery',
            'price' => '89.50',
            'main_image' => 'imgs/hoops1.webp',
            'hover_image' => 'imgs/hoops2.webp',
            'detail_page' => 'earring-detail-2.php',
            'badge' => null
        ],
        [
            'id' => 3,
            ...
            'category' => 'Jewellery',
            'price' => '350.00',
            'main_image' => 'imgs/Diamond Studs1.webp',
            'hover_image' => 'imgs/diamond 2.webp',
            'detail_page' => 'earring-detail-3.php',
            'badge' => 'Best'
        ],
        [
            'id' => 4,
            ...
            'category' => 'Jewellery',
            'price' => '65.99',
            'main_image' => 'imgs/Feather Dangles.webp',
            'hover_image' => 'imgs/Feather Dangles2.webp',
            'detail_page' => 'earring-detail-4.php',
            'badge' => null
        ],
        [
            'id' => 5,
            'name' => 'Geometric Drops',
            'category' => 'Jewellery',
            'price' => '95.00',
            'main_image' => 'imgs/Geometric Drops.webp',
            'hover_image' => 'imgs/Geometric Drops2.webp',
            'detail_page' => 'earring-detail-5.php',
            'badge' => null
        ],
        [
            'id' => 6,
            'name' => 'Rose Gold Halos',
            'category' => 'Jewellery',
            'price' => '210.00',
            'main_image' => 'imgs/Rose Gold Halos.webp',
            'hover_image' => 'imgs/Rose Gold Halos2.webp',
            'detail_page' => 'earring-detail-6.php',
            'badge' => null
        ]
    ];
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        foreach ($jewelleryCategories as $name => $file) {
                            // The active class for the current page (Earrings)
    ...
    <section class="category-header">
        <div class="container">
            <h1>Earrings</h1>
            <p><a href="index.php">Home</a> &gt; Earrings</p>
        </div>
    </section>

    <main class="product-grid-container">
        <div class="product-grid">
            <?php foreach ($earringsProducts as $product): ?>
                <a href="<?php echo htmlspecialchars($product['detail_page']); ?>" class="product-card-link">
                    <div class="product-card">
                        <div class="product-image-wrapper">
                            <img src="<?php echo htmlspecialchars($product['main_image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Front" class="product-main-image">
                            <img src="<?php echo htmlspecialchars($product['hover_image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Back" class="product-hover-image">
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Close mobile menu and search bar when clicking outside (optional, but good UX)
            document.addEventListener('click', (event) => {
                // Check if click is outside mainNav and menuToggle
                if (mainNav.classList.contains('open') && !mainNav.contains(event.target) && !menuToggle.contains(event.target)) {
                    mainNav.classList.remove('open');
                }
                // Check if click is outside searchBar and searchIconInline
                if (searchBar.classList.contains('open') && !searchBar.contains(event.target) && !searchIconInline.contains(event.target)) {
                    searchBar.classList.remove('open');
                }
            });
        });
