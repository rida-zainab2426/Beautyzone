...
// Define product details for Tinted Cheek Balm
$product = [
    'id' => 'TCB001', // Unique Product ID for Tinted Cheek Balm
    'name' => 'Tinted Cheek Balm',
    'price' => 16.00,
    'image' => 'imgs/tinted blush2.webp', // Ensure this path is correct
    'hover_image' => 'imgs/tinted blush3.webp', // If you have a hover image
    'description' => 'Experience the weightless, buildable flush of our Liquid Blush. This innovative formula delivers a seamless, dewy finish that blends effortlessly for a natural, healthy glow. Infused with skin-loving ingredients, it provides a luminous tint that lasts for hours, enhancing your complexion with a radiant pop of color. Ideal for all skin tones, it\'s perfect for achieving a fresh, vibrant look.',
    'stock' => 65, // Example stock
    'reviews_count' => 15, // Number of reviews
    'rating' => 5, // Average rating (assuming 5 stars from your HTML)
];
...
// Calculate total items in cart for the badge (from test.php)
$totalCartItems = 0; //
if (isset($_SESSION['cart'])) { //
...
<head>
    ...
    <title>Tinted Cheek Balm - Beautyzone</title>
...
<body>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="blushes.php">Blushes</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="tinted_cheek_balm_detail.php" method="post">
