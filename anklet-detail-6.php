...
// Define product details for Natural Seashell Anklet
$product = [
    'id' => 'NSA006', // Unique Product ID for Natural Seashell Anklet
    'name' => 'Natural Seashell Anklet',
    'price' => 28.00,
    'image' => 'imgs/Natural seashell.webp',
    'hover_image' => 'imgs/Natural seashell2.webp', // If you have a hover image
    'description' => 'Embrace the essence of the ocean with our Natural Seashell Anklet. Crafted with genuine small seashells strung on a durable, adjustable cord, this anklet brings a touch of beach-inspired charm to your look. Perfect for summer days, beach outings, or simply to carry a piece of the seaside with you wherever you go.',
    'stock' => 60, // Example stock
    'reviews' => 75, // Example reviews
];
...
<head>
    ...
    <title>Natural Seashell Anklet - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($jewelleryCategories)) || basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_pearl_pendant_necklace.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_sterling_silver_choker.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_crystal_necklace.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_zodiac_necklace.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_multi_layered_necklace.php' || basename($_SERVER['PHP_SELF']) == 'earring-detail-1.php' || basename($_SERVER['PHP_SELF']) == 'earring-detail-2.php' || basename($_SERVER['PHP_SELF']) == 'earring-detail-3.php' || basename($_SERVER['PHP_SELF']) == 'earring-detail-4.php' || basename($_SERVER['PHP_SELF']) == 'earring-detail-5.php' || basename($_SERVER['PHP_SELF']) == 'earring-detail-6.php' || basename($_SERVER['PHP_SELF']) == 'ring-detail-1.php' || basename($_SERVER['PHP_SELF']) == 'ring-detail-2.php' || basename($_SERVER['PHP_SELF']) == 'ring-detail-3.php' || basename($_SERVER['PHP_SELF']) == 'ring-detail-4.php' || basename($_SERVER['PHP_SELF']) == 'ring-detail-5.php' || basename($_SERVER['PHP_SELF']) == 'ring-detail-6.php' || basename($_SERVER['PHP_SELF']) == 'bracelet-detail-1.php' || basename($_SERVER['PHP_SELF']) == 'bracelet-detail-2.php' || basename($_SERVER['PHP_SELF']) == 'bracelet-detail-3.php' || basename($_SERVER['PHP_SELF']) == 'bracelet-detail-4.php' || basename($_SERVER['PHP_SELF']) == 'bracelet-detail-5.php' || basename($_SERVER['PHP_SELF']) == 'bracelet-detail-6.php' || basename($_SERVER['PHP_SELF']) == 'anklet-detail-1.php' || basename($_SERVER['PHP_SELF']) == 'anklet-detail-2.php' || basename($_SERVER['PHP_SELF']) == 'anklet-detail-3.php' || basename($_SERVER['PHP_SELF']) == 'anklet-detail-4.php' || basename($_SERVER['PHP_SELF']) == 'anklet-detail-5.php' || basename($_SERVER['PHP_SELF']) == 'anklet-detail-6.php') ? 'active' : ''; ?>">Jewellery <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($jewelleryCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_pearl_pendant_necklace.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_sterling_silver_choker.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_crystal_necklace.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_zodiac_necklace.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_multi_layered_necklace.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'earring-detail-1.php' && $name == 'Earrings') || (basename($_SERVER['PHP_SELF']) == 'earring-detail-2.php' && $name == 'Earrings') || (basename($_SERVER['PHP_SELF']) == 'earring-detail-3.php' && $name == 'Earrings') || (basename($_SERVER['PHP_SELF']) == 'earring-detail-4.php' && $name == 'Earrings') || (basename($_SERVER['PHP_SELF']) == 'earring-detail-5.php' && $name == 'Earrings') || (basename($_SERVER['PHP_SELF']) == 'earring-detail-6.php' && $name == 'Earrings') || (basename($_SERVER['PHP_SELF']) == 'ring-detail-1.php' && $name == 'Rings') || (basename($_SERVER['PHP_SELF']) == 'ring-detail-2.php' && $name == 'Rings') || (basename($_SERVER['PHP_SELF']) == 'ring-detail-3.php' && $name == 'Rings') || (basename($_SERVER['PHP_SELF']) == 'ring-detail-4.php' && $name == 'Rings') || (basename($_SERVER['PHP_SELF']) == 'ring-detail-5.php' && $name == 'Rings') || (basename($_SERVER['PHP_SELF']) == 'ring-detail-6.php' && $name == 'Rings') || (basename($_SERVER['PHP_SELF']) == 'bracelet-detail-1.php' && $name == 'Bracelets') || (basename($_SERVER['PHP_SELF']) == 'bracelet-detail-2.php' && $name == 'Bracelets') || (basename($_SERVER['PHP_SELF']) == 'bracelet-detail-3.php' && $name == 'Bracelets') || (basename($_SERVER['PHP_SELF']) == 'bracelet-detail-4.php' && $name == 'Bracelets') || (basename($_SERVER['PHP_SELF']) == 'bracelet-detail-5.php' && $name == 'Bracelets') || (basename($_SERVER['PHP_SELF']) == 'bracelet-detail-6.php' && $name == 'Bracelets') || (basename($_SERVER['PHP_SELF']) == 'anklet-detail-1.php' && $name == 'Anklets') || (basename($_SERVER['PHP_SELF']) == 'anklet-detail-2.php' && $name == 'Anklets') || (basename($_SERVER['PHP_SELF']) == 'anklet-detail-3.php' && $name == 'Anklets') || (basename($_SERVER['PHP_SELF']) == 'anklet-detail-4.php' && $name == 'Anklets') || (basename($_SERVER['PHP_SELF']) == 'anklet-detail-5.php' && $name == 'Anklets') || (basename($_SERVER['PHP_SELF']) == 'anklet-detail-6.php' && $name == 'Anklets')) ? 'active' : '';
                            echo '<li><a href="' . htmlspecialchars($file) . '" class="' . $activeClass . '">' . htmlspecialchars($name) . '</a></li>';
                        }
                        ?>
                    </ul>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="anklets.php">Jewellery</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="anklet-detail-6.php" method="post">
