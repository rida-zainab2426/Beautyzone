...
// Define product details for Pearl Cluster Ring
$product = [
    'id' => 'PCR006', // Unique Product ID for Pearl Cluster Ring
    'name' => 'Pearl Cluster Ring',
    'price' => 120.00,
    'image' => 'imgs/Pearl Cluster Ring.webp',
    'hover_image' => 'imgs/Pearl Cluster Ring2.webp', // If you have a hover image
    'description' => 'Adorn your hand with the ethereal beauty of our Pearl Cluster Ring. This captivating piece features a delicate cluster of lustrous freshwater pearls, expertly arranged to create a unique and enchanting design. Set on a slender sterling silver band, its timeless elegance makes it perfect for both special occasions and adding a touch of sophistication to your everyday style. A true testament to classic beauty.',
...
<head>
    ...
    <title>Pearl Cluster Ring - Beautyzone</title>
...
<body>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="rings.php">Jewellery</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="ring-detail-6.php" method="post">
