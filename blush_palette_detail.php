...
// Define product details for Radiant Glow Blush Palette
$product = [
    'id' => 'BPL001', // Unique Product ID for Blush Palette
    'name' => 'Radiant Glow Blush Palette',
    'price' => 25.00,
    'image' => 'imgs/blush palette.webp',
    'hover_image' => 'imgs/blush palette2.webp', // If you have a hover image
    'description' => 'Unleash your inner artist with our Radiant Glow Blush Palette. Featuring a curated selection of highly pigmented, blendable blush shades in both matte and shimmer finishes, this palette allows you to effortlessly sculpt, define, and add a luminous flush to your cheeks. Formulated for long-lasting wear and a smooth application, it\'s suitable for all skin tones and perfect for creating a natural everyday look or a captivating evening glow.',
    'stock' => 35, // Example stock
    'reviews_count' => 7, // Number of reviews
...
<head>
    ...
    <title>Blush Palette - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'liquid_matte_lipstick_detail.php' || basename($_SERVER['PHP_SELF']) == 'velvet_matte_lipstick_detail.php' || basename($_SERVER['PHP_SELF']) == 'hydrating_lip_gloss_detail.php' || basename($_SERVER['PHP_SELF']) == 'long_lasting_lip_liner_detail.php' || basename($_SERVER['PHP_SELF']) == 'sheer_tinted_lip_balm_detail.php' || basename($_SERVER['PHP_SELF']) == 'creamy_satin_lipstick_detail.php' || basename($_SERVER['PHP_SELF']) == 'blush_palette_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        // Also make the specific category active if on a detail page for that category
                        foreach ($cosmeticCategories as $name => $file) {
                            $activeClass = '';
                            if (basename($_SERVER['PHP_SELF']) == $file) {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'liquid_matte_lipstick_detail.php' && $name == 'Lipsticks') {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'velvet_matte_lipstick_detail.php' && $name == 'Lipsticks') {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'hydrating_lip_gloss_detail.php' && $name == 'Lipsticks') {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'long_lasting_lip_liner_detail.php' && $name == 'Lipsticks') {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'sheer_tinted_lip_balm_detail.php' && $name == 'Lipsticks') {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'creamy_satin_lipstick_detail.php' && $name == 'Lipsticks') {
                                $activeClass = 'active';
                            } else if (basename($_SERVER['PHP_SELF']) == 'blush_palette_detail.php' && $name == 'Blushes') {
                                $activeClass = 'active';
                            }
    ...
    <header class="category-header">
        <div class="container">
            <h1>Blush Palette</h1>
            <p><a href="index.php">Home</a> - <a href="blushes.php">Blushes</a> - Blush Palette</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="Blush Palette Main" class="product-main-image" id="mainProductImage">
                <img src="<?php echo htmlspecialchars($product['hover_image']); ?>" alt="Blush Palette Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="Blush Palette Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="<?php echo htmlspecialchars($product['hover_image']); ?>" alt="Blush Palette Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>
        ...
        <div class="product-info">
            ...
            <div class="customer-review-summary">
                ...
                (<?php echo htmlspecialchars($product['reviews_count']); ?> Customer Reviews)
            </div>
            ...
            <form action="blush_palette_detail.php" method="post">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="text" value="1" id="productQuantity" name="quantity" readonly>
