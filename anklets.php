...
<head>
    ...
    <title>Anklets - Beautyzone</title>
    ...
    <style>
        ...
        .logo {
            ...
            font-weight: 700;
            color: var(--dark-text); /* Or any color you prefer for the text logo */
        ...
        /* Remove img specific styling as it's no longer an image */
        /* .logo img {
            height: 60px;
            width: auto;
            display: block;
        ...
        @media (max-width: 768px) {
            ...
            /* .logo img { height: 50px; } */ /* Removed as logo is now text */
        ...
        @media (max-width: 480px) {
            ...
            /* .logo img { height: 40px; } */ /* Removed as logo is now text */
...
<body>
    ...
    $jewelleryCategories = [
        ...
        'Anklets' => 'anklets.php' // This is the current page
    ];
    ...
    <header>
        <div class="logo">
            <a href="index.php">Beautyzone</a> </div>
        <nav>
    ...
    <section class="category-header">
        <div class="container">
            <h1>Anklets</h1>
            <p><a href="index.php">Home</a> &gt; Anklets</p>
        </div>
    </section>

    <main class="product-grid-container">
        <div class="product-grid">
            <a href="anklet-detail-1.php" class="product-card-link">
                <div class="product-card">
                    <div class="product-image-wrapper">
                        <img src="imgs/delicate chain ankle2.webp" alt="Delicate Chain Anklet Front" class="product-main-image">
                        <img src="imgs/delicate chain ankle2.webp" alt="Delicate Chain Anklet Back" class="product-hover-image">
                    </div>
                    <div class="product-details">
                        <p class="product-category">Jewellery</p>
                        <h3 class="product-title">Delicate Chain Anklet</h3>
                        <p class="product-price">$35.00</p>
                    </div>
                </div>
            </a>

            <a href="anklet-detail-2.php" class="product-card-link">
                <div class="product-card">
                    <div class="product-image-wrapper">
                        <img src="imgs/beaded ankle.webp" alt="Bohemian Beaded Anklet Front" class="product-main-image">
                        <img src="imgs/beaded ankle.webp" alt="Bohemian Beaded Anklet Back" class="product-hover-image">
                    </div>
                    <div class="product-details">
                        <p class="product-category">Jewellery</p>
                        <h3 class="product-title">Bohemian Beaded Anklet</h3>
            ...
            <a href="anklet-detail-3.php" class="product-card-link">
                <div class="product-card">
                    <div class="product-image-wrapper">
                        <img src="imgs/Silver charm ankle.webp" alt="Silver Charm Anklet Front" class="product-main-image">
                        <img src="imgs/Silver charm ankle2.webp" alt="Silver Charm Anklet Back" class="product-hover-image">
                    </div>
                    <div class="product-details">
                        <p class="product-category">Jewellery</p>
                        <h3 class="product-title">Silver Charm Anklet</h3>
                        <p class="product-price">$49.99</p>
                    </div>
                </div>
            </a>

            <a href="anklet-detail-4.php" class="product-card-link">
                <div class="product-card">
                    <div class="product-image-wrapper">
                        <img src="imgs/Golden Layered ankle.webp" alt="Gold Layered Anklet Front" class="product-main-image">
                        <img src="imgs/Golden Layered ankle2.webp" alt="Gold Layered Anklet Back" class="product-hover-image">
                    </div>
                    <div class="product-details">
                        <p class="product-category">Jewellery</p>
                        <h3 class="product-title">Gold Layered Anklet</h3>
            ...
            <a href="anklet-detail-5.php" class="product-card-link">
                <div class="product-card">
                    <div class="product-image-wrapper">
                        <img src="imgs/Sparkling Crystal ankle.webp" alt="Sparkling Crystal Anklet Front" class="product-main-image">
                        <img src="imgs/Sparkling Crystal ankle2.webp" alt="Sparkling Crystal Anklet Back" class="product-hover-image">
                    </div>
                    <div class="product-details">
                        <p class="product-category">Jewellery</p>
                        <h3 class="product-title">Sparkling Crystal Anklet</h3>
                        <p class="product-price">$55.00</p>
                    </div>
                </div>
            </a>

            <a href="anklet-detail-6.php" class="product-card-link">
                <div class="product-card">
                    <div class="product-image-wrapper">
                        <img src="imgs/Natural seashell.webp" alt="Seashell Anklet Front" class="product-main-image">
                        <img src="imgs/Natural seashell2.webp" alt="Seashell Anklet Back" class="product-hover-image">
                    </div>
                    <div class="product-details">
                        <p class="product-category">Jewellery</p>
                        <h3 class="product-title">Natural Seashell Anklet</h3>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.addEventListener('click', (event) => {
                ...
                if (mainNav.classList.contains('open') && !mainNav.contains(event.target) && !menuToggle.contains(event.target)) {
                    mainNav.classList.remove('open');
                    // Also close any open dropdowns if the menu itself is closed
                    dropdowns.forEach(dropdown => {
