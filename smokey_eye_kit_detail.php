...
<head>
    ...
    <title>Smokey Eye Kit - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'smokey_eye_kit_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Smokey Eye Kit</h1>
            <p><a href="index.php">Home</a> - <a href="eyeshadows.php">Eye Shadows</a> - Smokey Eye Kit</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Smokey Eye Kit.webp" alt="Smokey Eye Kit Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Smokey Eye Kit2.webp" alt="Smokey Eye Kit Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Smokey Eye Kit.webp" alt="Smokey Eye Kit Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Smokey Eye Kit2.webp" alt="Smokey Eye Kit Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="smokey_eye_kit">Smokey Eye Kit</h1>
            ...
            <p class="product-price" data-price="38.00">$38.00</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">40</span> Items</p>
            <p class="product-description">
                Achieve the perfect smokey eye with our all-in-one Smokey Eye Kit. This curated collection includes highly pigmented eyeshadows, a precision eyeliner, and a blending brush, everything you need for a stunning, dramatic look that lasts.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="smokey_eye_kit">
                <input type="hidden" name="name" value="Smokey Eye Kit">
                <input type="hidden" name="price" value="38.00">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Smokey Eye Kit.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-box"></i> Complete Smokey Eye Collection</li>
                <li><i class="fas fa-palette"></i> Richly Pigmented Eyeshadows</li>
                <li><i class="fas fa-pencil-alt"></i> Precision Eyeliner Included</li>
                <li><i class="fas fa-brush"></i> Blending Brush for Seamless Looks</li>
                <li><i class="fas fa-magic"></i> Long-Lasting & Smudge-Proof</li>
            </ul>
        </div>
    </div>
