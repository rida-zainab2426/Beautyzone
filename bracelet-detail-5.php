...
// Define product details for Chain Bracelet
$product = [
    'id' => 'CHB001', // Unique Product ID for Chain Bracelet
    'name' => 'Chain Bracelet',
    'price' => 60.00,
    'image' => 'imgs/Chain Bracelet.webp',
    'hover_image' => 'imgs/Chain Bracelet2.webp', // If you have a hover image
    'description' => 'Embrace minimalist elegance with our classic Chain Bracelet. Crafted from high-quality sterling silver (or gold-plated/rose gold-plated metal – specify if known), this bracelet features a delicate yet durable chain design that wraps effortlessly around the wrist. Its simplicity makes it incredibly versatile, perfect for everyday wear or for layering with other bracelets to create a personalized stack. The adjustable clasp ensures a secure and comfortable fit, making it an ideal gift or a timeless addition to your own jewelry collection.',
    'stock' => 45, // Example stock
    'reviews' => 18, // Example reviews
];
...
// Handle adding to cart - LOGIC FROM test.php
...
<head>
    ...
    <title>Chain Bracelet - Beautyzone</title>
    ...
    <style>
        ...
        .category-header::before {
            ...
            transform: translateY(-50%) rotate(10deg); /* Slightly less rotation than other details */
...
<body>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="bracelets.php">Jewellery</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <div class="customer-review-summary">
                <span class="stars">
                    <?php for ($i = 0; $i < floor($product['reviews'] / 2); $i++): ?><i class="fas fa-star"></i><?php endfor; ?>
                    <?php if ($product['reviews'] % 2 != 0): ?><i class="fas fa-star-half-alt"></i><?php endif; ?>
                    <?php for ($i = 0; $i < (5 - ceil($product['reviews'] / 2)); $i++): ?><i class="far fa-star"></i><?php endfor; ?>
                </span>
            ...
            <form action="bracelet-detail-5.php" method="post">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="text" name="quantity" id="productQuantity" value="1" min="1" readonly>
