...
// Define product details for Diamond Studs
$product = [
    'id' => 'EDIAM003', // Unique Product ID for Diamond Studs
    'name' => 'Diamond Studs',
    'price' => 250.00,
    // IMPORTANT: Ensure these paths are correct relative to where your shopping_cart.php and product_detail files are.
    'image' => 'imgs/Diamond Studs1.webp', // Main image path
    'hover_image' => 'imgs/diamond 2.webp', // Hover image path
    'description' => 'Experience timeless elegance with our exquisite Diamond Stud earrings. Each stud features a brilliant-cut diamond, meticulously set in a classic four-prong design to maximize its sparkle and brilliance. Perfect for everyday wear or special occasions, these earrings are a symbol of enduring beauty and sophistication. Crafted with the highest quality materials, they offer both dazzling appeal and lasting comfort, making them an essential addition to any fine jewelry collection.',
    'stock' => 15, // Example stock
    'reviews' => 25, // Example reviews
];
...
<body>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="earring-detail-3.php" method="post">
