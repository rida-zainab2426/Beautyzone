...
// Define product details for Anti-Aging Serum
$product = [
    'id' => 'AAS001', // Unique Product ID for Anti-Aging Serum
    'name' => 'Anti-Aging Serum',
    'price' => 32.00,
    'image' => 'imgs/anti-aging serum.webp', // Original path as requested to keep same
    'hover_image' => 'imgs/anti-aging serum2.webp', // Original path as requested to keep same
    'description' => 'Unleash your skin\'s youthful potential with our advanced Anti-Aging Serum. This potent formula is packed with peptides, antioxidants, and hyaluronic acid, working synergistically to reduce the appearance of fine lines and wrinkles, improve skin elasticity, and boost collagen production. It deeply hydrates and revitalizes, leaving your complexion smoother, firmer, and visibly younger-looking. Lightweight and fast-absorbing, it\'s the perfect addition to any skincare regimen.',
    'stock' => 40, // Example stock
    'reviews_count' => 22, // Number of reviews
    'rating' => 4.5, // Average rating based on original HTML
];
...
<body>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="anti_aging_serum.php" method="post">
