...
// Product details for "Liquid Matte Lipstick"
$currentProductId = 'LML001';
$currentProductName = 'Liquid Matte Lipstick';
$currentProductPrice = 12.00; // Example price
$currentProductImage = 'imgs/Liquid Matte Lipstick.webp'; // Main image for this product
...
if (isset($_POST['add_to_cart'])) {
    ...
    if (isset($_SESSION['cart'][$productId])) {
        ...
        $_SESSION['cart'][$productId] = [
            ...
            'price' => $productPrice,
            'quantity' => $quantity,
            'image' => $currentProductImage // You might want to pass this to shopping_cart.php too
        ];
    }
    // Redirect to shopping_cart.php after adding to cart
...
<head>
    ...
    <title>Liquid Matte Lipstick - Beautyzone</title>
    ...
    <style>
        ...
        .category-header p {
            ...
            text-align: center;
            margin: 0 auto; /* Center the block itself if it were smaller than container */
        }
        ...
        @media (max-width: 768px) {
            ...
            .logo span { font-size: 2em; } /* Adjusted for mobile */
...
<body>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        foreach ($cosmeticCategories as $name => $file) {
                            // Check if the current page is one of the lipstick detail pages
                            $isLipstickDetailPage = (basename($_SERVER['PHP_SELF']) == 'liquid_matte_lipstick_detail.php' ||
                                                       basename($_SERVER['PHP_SELF']) == 'velvet_matte_lipstick_detail.php' ||
                                                       basename($_SERVER['PHP_SELF']) == 'hydrating_lip_gloss_detail.php' ||
                                                       basename($_SERVER['PHP_SELF']) == 'long_lasting_lip_liner_detail.php' ||
                                                       basename($_SERVER['PHP_SELF']) == 'sheer_tinted_lip_balm_detail.php' ||
                                                       basename($_SERVER['PHP_SELF']) == 'creamy_satin_lipstick_detail.php');

                            $activeClass = '';
                            if (basename($_SERVER['PHP_SELF']) == $file) {
                                $activeClass = 'active';
                            } elseif ($isLipstickDetailPage && $name == 'Lipsticks') {
                                // If on any lipstick detail page, make "Lipsticks" category active
                                $activeClass = 'active';
                            }
    ...
    <header class="category-header">
        <div class="container">
            <h1>Liquid Matte Lipstick</h1>
            <p><a href="index.php">Home</a> - <a href="lipsticks.php">Lipsticks</a> - Liquid Matte Lipstick</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Liquid Matte Lipstick.webp" alt="Liquid Matte Lipstick Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Liquid Matte Lipstick2.webp" alt="Liquid Matte Lipstick Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Liquid Matte Lipstick.webp" alt="Liquid Matte Lipstick Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Liquid Matte Lipstick2.webp" alt="Liquid Matte Lipstick Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title">Liquid Matte Lipstick</h1>
            ...
            <p class="product-price">$<?php echo number_format($currentProductPrice, 2); ?></p>
            <p class="product-availability">In Stock: <span id="itemsInStock">50</span> Items</p>
            <p class="product-description">
                Experience the ultimate in matte liquid lipstick with our Liquid Matte Lipstick. Its feather-light formula delivers rich, opaque color in a single swipe, drying down to a comfortable, non-sticky matte finish that lasts all day. Infused with moisturizing agents, it keeps your lips feeling soft and hydrated, never cracked or dry. Perfect for any occasion, from a casual day out to a glamorous evening event. Our innovative applicator ensures precise application for a perfectly defined pout every time.
            </p>

            <form action="liquid_matte_lipstick_detail.php" method="post">
                <input type="hidden" name="product_id" value="<?php echo htmlspecialchars($currentProductId); ?>">
                <input type="hidden" name="product_name" value="<?php echo htmlspecialchars($currentProductName); ?>">
                <input type="hidden" name="product_price" value="<?php echo htmlspecialchars($currentProductPrice); ?>">
                <div class="quantity-selector">
                    <button type="button" id="subtractQuantity">-</button>
                    <input type="text" name="quantity" value="1" id="productQuantity" readonly>
...
<?php include 'footer.php'; ?>
    ...
    <script>
        ...
        // Navbar and Search Bar functionality (copied from index.php)
        const searchIcon = document.querySelector('.search-icon');
        const searchBar = document.querySelector('.search-bar');
        const header = document.querySelector('header');
        const productSearchInput = document.getElementById('productSearchInput'); // Ensure this ID exists on the search input
        ...
        // Dropdown Menu Functionality (for mobile/tablet) - copied from index.php
        ...
        function changeMainImage(thumbnail) {
            ...
            const productHoverImage = document.querySelector('.product-hover-image'); // Get the hover image element

            // Set both main and hover image sources to the clicked thumbnail's source
            mainProductImage.src = thumbnail.src;
            productHoverImage.src = thumbnail.src; // Ensure hover image also updates to match
