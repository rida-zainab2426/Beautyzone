...
// Define product details for Multi-Layered Necklace
$product = [
    'id' => 'MLN001', // Unique Product ID for Multi-Layered Necklace
    'name' => 'Multi-Layered Necklace',
    'price' => 16.00,
    // IMPORTANT: Ensure these paths are correct relative to where your shopping_cart.php and product_detail files are.
    // These paths are taken directly from the existing HTML in product_detail_multi_layered_necklace.php
    'image' => 'imgs/Multi-Layered Necklace Set2.webp',
    'hover_image' => 'imgs/multi necklace.webp',
    'description' => 'Elevate your style with our chic Multi-Layered Necklace, designed for effortless elegance. This necklace features multiple delicate chains of varying lengths, adorned with complementary charms and subtle embellishments. It offers a contemporary look that perfectly blends sophistication with a touch of bohemian flair, ideal for layering or wearing as a standalone statement piece.',
...
<head>
    ...
    <title>Multi-Layered Necklace - Beautyzone</title>
...
<body>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="necklaces.php">Jewellery</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="product_detail_multi_layered_necklace.php" method="post">
