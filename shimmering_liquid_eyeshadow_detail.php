...
<head>
    ...
    <title>Shimmering Liquid Eyeshadow - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'shimmering_liquid_eyeshadow_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Shimmering Liquid Eyeshadow</h1>
            <p><a href="index.php">Home</a> - <a href="eyeshadows.php">Eye Shadows</a> - Shimmering Liquid Eyeshadow</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Shimmering Liquid Eyeshadow.webp" alt="Shimmering Liquid Eyeshadow Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Shimmering Liquid Eyeshadow2.webp" alt="Shimmering Liquid Eyeshadow Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Shimmering Liquid Eyeshadow.webp" alt="Shimmering Liquid Eyeshadow Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Shimmering Liquid Eyeshadow2.webp" alt="Shimmering Liquid Eyeshadow Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="shimmering_liquid_eyeshadow">Shimmering Liquid Eyeshadow</h1>
            ...
            <p class="product-price" data-price="18.99">$18.99</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">75</span> Items</p>
            <p class="product-description">
                Add a touch of dazzling sparkle to your eyes with our Shimmering Liquid Eyeshadow. This innovative formula glides on effortlessly, delivering intense color payoff and a multi-dimensional shimmer that lasts all day without creasing or fading. Perfect for a quick glam look or to elevate any eye makeup.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="shimmering_liquid_eyeshadow">
                <input type="hidden" name="name" value="Shimmering Liquid Eyeshadow">
                <input type="hidden" name="price" value="18.99">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Shimmering Liquid Eyeshadow.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-sparkles"></i> Dazzling Shimmer Finish</li>
                <li><i class="fas fa-spray-can"></i> Effortless Application</li>
                <li><i class="fas fa-palette"></i> Intense Color Payoff</li>
                <li><i class="fas fa-clock"></i> Long-Lasting & Crease-Proof</li>
                <li><i class="fas fa-hand-sparkles"></i> Quick Glam Look</li>
            </ul>
        </div>
    </div>
