...
// --- Product Data for Hydrating Lip Gloss ---
// In a real application, this would come from a database based on a product ID
$product = [
    'id' => 'HLG001', // Unique product ID
    'name' => 'Hydrating Lip Gloss',
    'price' => 12.00,
    'stock' => 50,
    'description' => 'Achieve a luscious, high-shine pout with our Hydrating Lip Gloss. This non-sticky formula is infused with nourishing ingredients like Vitamin E and Jojoba Oil to keep your lips feeling soft, smooth, and moisturized all day long. Its subtle tint provides a natural wash of color while enhancing your lips with a dazzling, plumped-up effect. Perfect for everyday wear or layering over your favorite lipstick for added dimension and shine.',
    'main_image' => 'imgs/Hydrating Lip Gloss.webp',
    'hover_image' => 'imgs/Hydrating Lip Gloss2.webp', // Assuming you want a hover image
    'thumbnail_images' => [
        'imgs/Hydrating Lip Gloss.webp',
        'imgs/Hydrating Lip Gloss2.webp',
        // Add more thumbnail images if available, e.g., 'imgs/Hydrating Lip Gloss3.webp'
    ],
    'features' => [
    ...
    'reviews' => 3 // Number of customer reviews
];
    ...
    if ($quantity > 0 && $quantity <= $product['stock']) {
        if (isset($_SESSION['cart'][$product_id])) {
            ...
            $_SESSION['cart'][$product_id] = [
                'name' => $product['name'],
                'price' => $product['price'],
                'image' => $product['main_image'], // Use main image for cart display
                'quantity' => $quantity
            ];
        }
        // Redirect to the shopping cart page after adding
        header('Location: shopping_cart.php');
        exit;
    } else {
        // Optionally handle invalid quantity (e.g., show an error message)
        // For now, we'll just ignore it or could set a session flash message
    }
}
...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <div class="user-actions">
                ...
                <a href="shopping_cart.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'shopping_cart.php') ? 'active' : ''; ?>"><i class="fas fa-shopping-bag"></i> <span class="badge" id="cartBadge"><?php echo $cartItemCount; ?></span></a>
            </div>
        </nav>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="<?php echo htmlspecialchars($product['main_image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Main" class="product-main-image" id="mainProductImage">
            ...
            <div class="thumbnail-images">
                <?php foreach ($product['thumbnail_images'] as $index => $thumbnail_image): ?>
                    <img src="<?php echo htmlspecialchars($thumbnail_image); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Thumbnail <?php echo $index + 1; ?>" class="thumbnail-image <?php echo ($index === 0) ? 'active' : ''; ?>" onclick="changeMainImage(this)">
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="product-info">
            ...
            <form method="POST" action="hydrating_lip_gloss_detail.php">
    ...
    <script>
        ...
        let itemsInStock = parseInt(itemsInStockSpan.textContent); // Get stock from PHP-rendered value
        ...
        function changeMainImage(thumbnail) {
            ...
            // Also update the hover image source so it matches the currently selected main image
            if (productHoverImage) { // Check if hover image exists
