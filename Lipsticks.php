...
<head>
    ...
    <title>Lipsticks - Beautyzone</title>
    ...
    <style>
        ...
        .logo a {
            ...
            color: var(--dark-text); /* Set text color */
            font-family: 'Playfair Display', serif; /* Apply unique font */
            font-size: 2em; /* Adjust font size as needed */
            font-weight: 700; /* Make it bold */
        }
        .logo img { /* Keep this in case you revert or use elsewhere, but it's not used for text logo */
            height: 60px;
            width: auto;
            display: block;
        }
        ...
        @media (max-width: 768px) {
            ...
            .logo img { height: 50px; display: none; /* Hide image logo on mobile */ } /* Hide image logo on mobile */
        ...
        @media (max-width: 480px) {
            ...
            .logo a { font-size: 1.5em; } /* Further adjust font size for smaller screens */
            .logo img { height: 40px; display: none; } /* Hide image logo on smallest screens */
...
<body>
    ...
    $cosmeticCategories = [
        "Lipsticks" => "lipsticks.php", // This page itself
    ...
    <header class="category-header">
        <div class="container">
            <h1>Lipsticks</h1>
            <p><a href="index.php">Home</a> - Lipsticks</p>
        </div>
    </header>
    ...
    <main class="product-grid-container">
        <div class="container">
            <div class="product-grid" id="productGrid">
                <a href="liquid_matte_lipstick_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Lipsticks Foundation" data-title="Liquid Matte Lipstick">
                        <div class="product-image-wrapper">
                            <img src="imgs/Liquid Matte Lipstick.webp" alt="Liquid Matte Lipstick" class="product-main-image">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title">Liquid Matte Lipstick</h3>
                            <p class="product-price">Starts from $13.00</p>
                        </div>
                    </div>
                </a>

                <a href="velvet_matte_lipstick_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Lipsticks" data-title="Velvet Matte Lipstick">
                        <div class="product-image-wrapper">
                            <img src="imgs/Velvet Matte Lipstick.webp" alt="Velvet Matte Lipstick" class="product-main-image">
                            <img src="imgs/Velvet Matte Lipstick2.webp" alt="Velvet Matte Lipstick Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Lipsticks</p>
                ...
                <a href="hydrating_lip_gloss_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Lipsticks" data-title="Hydrating Lip Gloss">
                        <div class="product-image-wrapper">
                            <img src="imgs/Hydrating Lip Gloss.webp" alt="Hydrating Lip Gloss" class="product-main-image">
                            <img src="imgs/Hydrating Lip Gloss2.webp" alt="Hydrating Lip Gloss Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Lipsticks</p>
                            <h3 class="product-title">Hydrating Lip Gloss</h3>
                            <p class="product-price">Starts from $10.00</p>
                        </div>
                    </div>
                </a>

                <a href="long_lasting_lip_liner_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Lipsticks" data-title="Long-Lasting Lip Liner">
                        <div class="product-image-wrapper">
                            <img src="imgs/Long-Lasting Lip Liner2.webp" alt="Long-Lasting Lip Liner" class="product-main-image">
                            <img src="imgs/Long-Lasting Lip Linerfh.webp" alt="Long-Lasting Lip Liner Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Lipsticks</p>
                            <h3 class="product-title">Long-Lasting Lip Liner</h3>
                            <p class="product-price">Starts from $8.00</p>
                        </div>
                    </div>
                </a>

                <a href="sheer_tinted_lip_balm_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Lipsticks Skincare" data-title="Sheer Tinted Lip Balm">
                        <div class="product-image-wrapper">
                            <img src="imgs/Sheer Tinted Lip Balm.webp" alt="Sheer Tinted Lip Balm" class="product-main-image">
                            <img src="imgs/Sheer Tinted Lip Balm2.webp" alt="Sheer Tinted Lip Balm Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">LipCare</p>
                            <h3 class="product-title">Sheer Tinted Lip Balm</h3>
                            <p class="product-price">Starts from $7.00</p>
                        </div>
                    </div>
                </a>

                <a href="creamy_satin_lipstick_detail.php" class="product-card-link">
                    <div class="product-card" data-category="Lipsticks" data-title="Creamy Satin Lipstick">
                        <div class="product-image-wrapper">
                            <img src="imgs/Creamy Satin Lipstick.webp" alt="Creamy Satin Lipstick" class="product-main-image">
                            <img src="imgs/Creamy Satin Lipstick2.webp" alt="Creamy Satin Lipstick Hover" class="product-hover-image">
                        </div>
                        <div class="product-details">
                            <p class="product-category">Lipsticks</p>
                            <h3 class="product-title">Creamy Satin Lipstick</h3>
