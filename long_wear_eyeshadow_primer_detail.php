...
<head>
    ...
    <title>Long-Wear Eyeshadow Primer - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'long_wear_eyeshadow_primer_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Long-Wear Eyeshadow Primer</h1>
            <p><a href="index.php">Home</a> - <a href="eyeshadows.php">Eye Shadows</a> - Long-Wear Eyeshadow Primer</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Long-Wear Eyeshadow Primer2.webp" alt="Long-Wear Eyeshadow Primer Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Long-Wear Eyeshadow Primer3.webp" alt="Long-Wear Eyeshadow Primer Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Long-Wear Eyeshadow Primer2.webp" alt="Long-Wear Eyeshadow Primer Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Long-Wear Eyeshadow Primer3.webp" alt="Long-Wear Eyeshadow Primer Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="long_wear_eyeshadow_primer">Long-Wear Eyeshadow Primer</h1>
            ...
            <p class="product-price" data-price="16.50">$16.50</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">80</span> Items</p>
            <p class="product-description">
                Ensure your eyeshadow stays vibrant and crease-free all day with our Long-Wear Eyeshadow Primer. This lightweight, invisible formula creates a smooth canvas, enhancing color payoff and extending the wear of your favorite eye shadows. Say goodbye to fading and creasing!
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="long_wear_eyeshadow_primer">
                <input type="hidden" name="name" value="Long-Wear Eyeshadow Primer">
                <input type="hidden" name="price" value="16.50">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Long-Wear Eyeshadow Primer.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-check-circle"></i> Extends Eyeshadow Wear</li>
                <li><i class="fas fa-paint-brush"></i> Enhances Color Payoff</li>
                <li><i class="fas fa-ruler-horizontal"></i> Prevents Creasing & Fading</li>
                <li><i class="fas fa-lightbulb"></i> Lightweight & Invisible Finish</li>
                <li><i class="fas fa-leaf"></i> Vegan & Cruelty-Free</li>
            </ul>
        </div>
    </div>
