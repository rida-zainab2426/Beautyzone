...
<head>
    ...
    <style>
        ...
        .product-detail-image {
            flex: 1 1 45%; /* Allows image to take about half the width */
            padding: 20px;
            box-sizing: border-box;
            text-align: center;
        }
        ...
        .product-info {
            flex: 1 1 45%; /* Allows info to take about half the width */
            padding: 20px;
            box-sizing: border-box;
        }
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'liquid_matte_lipstick_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($cosmeticCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (basename($_SERVER['PHP_SELF']) == 'liquid_matte_lipstick_detail.php' && $name == 'Lipsticks')) ? 'active' : '';
    ...
    <main class="product-detail-container">
        <div class="product-detail-image">
            <img src="imgs/Liquid Matte Lipstick.webp" alt="Liquid Matte Lipstick">
        </div>
        <div class="product-info">
            ...
            <p class="product-description">
                Experience intense color and a velvety matte finish with our Liquid Matte Lipstick.
                Its lightweight formula glides on smoothly, offering long-lasting wear without drying
                your lips. Perfect for a bold statement or a subtle enhancement.
            </p>
...
<?php include 'footer.php';   ?>
    ...
    <script>
        ...
        // No productGrid or productCards on detail page, so no filtering logic here
