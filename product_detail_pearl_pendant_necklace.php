...
// Define product details for Pearl Pendant Necklace
$product = [
    'id' => 'PPN001', // Unique Product ID for Pearl Pendant Necklace
    ...
    'image' => 'imgs/pearl pendant necklace.webp',
    'hover_image' => 'imgs/pearl pendant necklace2.webp', // If you have a hover image
    'description' => 'Elevate your style with our exquisite Pearl Pendant Necklace. Featuring a lustrous freshwater pearl suspended from a delicate sterling silver chain, this necklace is a symbol of timeless elegance and sophistication. Its minimalist design makes it perfect for both everyday wear and special occasions, adding a touch of classic beauty to any ensemble. A must-have piece for every jewelry lover.',
    'stock' => 25, // Example stock
    'reviews' => 8, // Example reviews
];
...
<head>
    ...
    <title>Pearl Pendant Necklace - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($jewelleryCategories)) || basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_pearl_pendant_necklace.php') ? 'active' : ''; ?>">Jewellery <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($jewelleryCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_pearl_pendant_necklace.php' && $name == 'Necklaces')) ? 'active' : '';
                            echo '<li><a href="' . htmlspecialchars($file) . '" class="' . $activeClass . '">' . htmlspecialchars($name) . '</a></li>';
                        }
                        ?>
                    </ul>
    ...
    <header class="category-header">
        <div class="container">
            ...
            <p><a href="index.php">Home</a> - <a href="necklaces.php">Necklaces</a> - <?php echo htmlspecialchars($product['name']); ?></p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <div class="customer-review-summary">
                <span class="stars">
                    <?php for ($i = 0; $i < $product['reviews']; $i++): ?><i class="fas fa-star"></i><?php endfor; ?>
                </span>
            ...
            <form action="product_detail_pearl_pendant_necklace.php" method="post">
