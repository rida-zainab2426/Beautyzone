...
// Define product details for Beaded Bracelet
$product = [
    'id' => 'BDB001', // Unique Product ID for Beaded Bracelet
    'name' => 'Beaded Bracelet',
    'price' => 75.00,
    'image' => 'imgs/Beaded Bracelet.webp',
    'hover_image' => 'imgs/Beaded Bracelet2.webp', // If you have a hover image
    'description' => 'Add a touch of bohemian charm to your wrist with our exquisite Beaded Bracelet. Handcrafted with precision, this bracelet features an array of natural stone beads (e.g., amethyst, rose quartz, jade – specify if known) interspersed with delicate silver (or gold-plated) accents. Each bead is carefully selected for its unique color and texture, making every bracelet a one-of-a-kind piece. The durable elastic string ensures a comfortable and versatile fit for all wrist sizes. Perfect for layering or wearing on its own, this bracelet brings a subtle pop of color and positive energy to any outfit.',
    'stock' => 30, // Example stock
    'reviews' => 15, // Example reviews
];
...
<head>
    ...
    <title>Beaded Bracelet - Beautyzone</title>
...
<body>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="bracelet-detail-4.php" method="post">
