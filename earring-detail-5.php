...
// Define product details for Geometric Drops
$product = [
    'id' => 'EGEOM005', // Unique Product ID for Geometric Drops
    ...
    'image' => 'imgs/earrings9.webp', // Main image path
    'hover_image' => 'imgs/earrings10.webp', // Hover image path
    'description' => 'Make a modern statement with our Geometric Drop earrings. Featuring a bold and contemporary design, these earrings showcase interlocking geometric shapes crafted from polished metal. Their abstract yet elegant form adds an artistic flair to your look, perfect for those who appreciate minimalist design with an edge. Lightweight and comfortable for all-day wear.',
...
<body>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="earring-detail-5.php" method="post">
