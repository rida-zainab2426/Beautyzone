...
<head>
    ...
    <title>Nude Eyeshadow Palette - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($cosmeticCategories)) || basename($_SERVER['PHP_SELF']) == 'nude_eyeshadow_palette_detail.php') ? 'active' : ''; ?>">Cosmetics <i class="fas fa-chevron-down arrow"></i></a>
    ...
    <header class="category-header">
        <div class="container">
            <h1>Nude Eyeshadow Palette</h1>
            <p><a href="index.php">Home</a> - <a href="eyeshadows.php">Eye Shadows</a> - Nude Eyeshadow Palette</p>
        </div>
    </header>
    ...
    <div class="product-detail-container">
        <div class="product-images">
            <div class="product-detail-image-wrapper">
                <img src="imgs/Nude Eyeshadow Palette.webp" alt="Nude Eyeshadow Palette Main" class="product-main-image" id="mainProductImage">
                <img src="imgs/Nude Eyeshadow Palette2.webp" alt="Nude Eyeshadow Palette Hover" class="product-hover-image">
            </div>
            <div class="thumbnail-images">
                <img src="imgs/Nude Eyeshadow Palette.webp" alt="Nude Eyeshadow Palette Thumbnail 1" class="thumbnail-image active" onclick="changeMainImage(this)">
                <img src="imgs/Nude Eyeshadow Palette2.webp" alt="Nude Eyeshadow Palette Thumbnail 2" class="thumbnail-image" onclick="changeMainImage(this)">
            </div>
        </div>

        <div class="product-info">
            <h1 class="product-title" data-product-id="nude_eyeshadow_palette">Nude Eyeshadow Palette</h1>
            ...
            <p class="product-price" data-price="24.99">$24.99</p>
            <p class="product-availability">In Stock: <span id="itemsInStock">65</span> Items</p>
            <p class="product-description">
                Unleash your creativity with our versatile Nude Eyeshadow Palette. Featuring a collection of universally flattering matte and shimmering shades, this palette is perfect for creating endless day-to-night looks. The highly pigmented, blendable formulas ensure smooth application and long-lasting wear, making it a must-have for every makeup bag.
            </p>

            <form action="shopping_cart.php" method="get">
                <input type="hidden" name="action" value="add">
                <input type="hidden" name="product_id" value="nude_eyeshadow_palette">
                <input type="hidden" name="name" value="Nude Eyeshadow Palette">
                <input type="hidden" name="price" value="24.99">
                <input type="hidden" name="image" id="productHiddenImage" value="imgs/Nude Eyeshadow Palette.webp">
            ...
            <ul class="product-features-list">
                <li><i class="fas fa-palette"></i> 12 Versatile Nude Shades</li>
                <li><i class="fas fa-brush"></i> Highly Pigmented & Blendable</li>
                <li><i class="fas fa-adjust"></i> Matte & Shimmer Finishes</li>
                <li><i class="fas fa-hourglass-half"></i> Long-Lasting Wear</li>
