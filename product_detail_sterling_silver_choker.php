...
// Define product details for Sterling Silver Choker
$product = [
    'id' => 'SSC001', // Unique Product ID for Sterling Silver Choker
    ...
    'image' => 'imgs/sterling silver choker.webp',
    'hover_image' => 'imgs/sterling silver choker2.webp', // If you have a hover image
    'description' => 'Adorn your neckline with our contemporary Sterling Silver Choker. Crafted from high-quality sterling silver, this sleek and stylish choker necklace offers a modern touch to any outfit. Its adjustable length ensures a perfect fit, making it versatile for layering or wearing as a stand-alone statement piece. Ideal for those who appreciate understated elegance and modern design.',
    'stock' => 20, // Example stock
    'reviews' => 6, // Example reviews
];
...
<head>
    ...
    <title>Sterling Silver Choker - Beautyzone</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), array_values($jewelleryCategories)) || basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_pearl_pendant_necklace.php' || basename($_SERVER['PHP_SELF']) == 'product_detail_sterling_silver_choker.php') ? 'active' : ''; ?>">Jewellery <i class="fas fa-chevron-down arrow"></i></a>
                    <ul class="dropdown-menu">
                        <?php
                        foreach ($jewelleryCategories as $name => $file) {
                            $activeClass = (basename($_SERVER['PHP_SELF']) == $file || (basename($_SERVER['PHP_SELF']) == 'product_detail_delicate_gold_chain.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_pearl_pendant_necklace.php' && $name == 'Necklaces') || (basename($_SERVER['PHP_SELF']) == 'product_detail_sterling_silver_choker.php' && $name == 'Necklaces')) ? 'active' : '';
                            echo '<li><a href="' . htmlspecialchars($file) . '" class="' . $activeClass . '">' . htmlspecialchars($name) . '</a></li>';
                        }
                        ?>
                    </ul>
    ...
    <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <form action="product_detail_sterling_silver_choker.php" method="post">
